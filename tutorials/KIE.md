...
First, generate the configuration file through the Configuration File Generator. For a guide, please look at the [config file tutorial](tutorials/CONFIG.md).
